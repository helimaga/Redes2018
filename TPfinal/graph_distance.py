...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 27 18:12:36 2018
...
class GraphDistance:
    ...
    def edit_distance_path(self, p1, p2, g1, g2,
        ...
        """
                ...
                :param      function_mach_vertices:  function which gives a distance bewteen two vertices,
                                                    if None, it take the output of :meth:`get_matching_functions <ensae_teaching_cs.special.graph_distance.GraphDistance.get_matching_functions>`
    ...
    def distance_matching_graphs_paths(self, graph2,
        ...
        """
                ...
                :param      use_min:                  :meth:`edit_distance_path <ensae_teaching_cs.special.graph_distance.GraphDistance.edit_distance_path>`
